private class Paddle {
  ...
  public Paddle (float widthParameter, float heightParameter) { //Passsing Geometry
    ...
    textSize = width*1/15; //this might be too big and will need autosizer algorithm from CS20
  }//End Constructor
  //
  void draw() {
  ...
  void gamePlay() {
    ...
    text(Integer.toString(rightScore), leftBoardX, leftBoardY, boardSide, boardSide);
    text(Integer.toString(leftScore), rightBoardX, rightBoardY, boardSide, boardSide);
  }//End gamePlay
  //
  // Getters and Setters
  void generalReset() {
